...
2 Captured ARP Req/Rep packets, from 2 hosts.   Total size: 84                
 ...
 ```console
root@kali:~# nmap -sS -A -n -T5 192.168.43.3
...
Let's use `Nikto'.
```console
root@kali:~# nikto -h 192.168.43.3 -useproxy http://192.168.43.3:3128
- Nikto v2.1.6
---------------------------------------------------------------------------
+ Target IP:          192.168.43.3
+ Target Hostname:    192.168.43.3
+ Target Port:        80
+ Proxy:              192.168.43.3:3128
...
Now navigate to `http://192.168.43.3`.

There is nothing in the page.

Ok let's go to `http://192.168.43.3/robots.txt`.

Then go to `http://192.168.43.3/wolfcms`.

After going through some Googling.....We will go to `http://192.168.43.3/wolfcms/?/admin/`.
...
Now navigate to `http://192.168.43.3/wolfcms/public/rev.php`. And we will get a shell.
...
Ncat: Connection from 192.168.43.3:44895.
...
```console
root@kali:~# ssh sickos@192.168.43.3
sickos@192.168.43.3's password: 
 ...
 * Documentation:  https://help.ubuntu.com/
  ...
  Memory usage: 36%               IP address for eth0: 192.168.43.3
  Swap usage:   0%
